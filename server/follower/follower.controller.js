...
exports.follow = async (req, res) => {
  try {
    ...
    const compareDate =
      fromUserExist.expiration_date <= toUserExist.expiration_date
        ? fromUserExist.expiration_date
        : toUserExist.expiration_date;

    const followerData = {
      fromUserId: fromUserExist._id,
      toUserId: toUserExist._id,
      expiration_date: compareDate,
    };
...
exports.followUnFollow = async (req, res) => {
  try {
    ...
    const compareDate =
      fromUserExist.expiration_date <= toUserExist.createdAt
        ? fromUserExist.expiration_date
        : toUserExist.createdAt;
    // follow
    const followerData = {
      fromUserId: fromUserExist._id,
      toUserId: toUserExist._id,
